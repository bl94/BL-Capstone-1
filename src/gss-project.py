...
ax.hist(lst, histtype='bar', label=['Health', 'Time felt happy', 'Time felt depressed'], edgecolor='k')
ax.set_title('Health Ratings and Time Felt Happy/Depressed', size=15, color='navy')
ax.set_xlabel('Health rating and frequency of feelings', size=12)
ax.set_ylabel('# of Respondents', size=15)
...
ax.set_title('Bootstrapped Means for 2016 health ratings', size=20, color='navy')
ax.set_xlabel('Health rating for past year', size=15)
ax.set_ylabel('# of Respondents', size=15)
ticks = [1,2,3,4]
plt.xticks(ticks)
# plt.show()
...
ax.set_xlabel('Time felt happy in past year', size=15)
ax.set_ylabel('# of Respondents', size=15)
ticks = [1,2,3,4]
...
ax.set_title('Bootstrapped Means', size=20, color='navy')
ax.set_xlabel('Time felt depressed in past year', size=15)
ax.set_ylabel('# of Respondents', size=15)
ticks = [1,2,3,4]
labels = ['Almost none', 'Some', 'Most', 'Almost all']
plt.xticks(ticks, labels)
